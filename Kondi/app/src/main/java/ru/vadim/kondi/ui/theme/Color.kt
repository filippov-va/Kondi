package ru.vadim.kondi.ui.theme
...
//Dark
val md_theme_dark_primary = Color(0xFF201A1A)  //статусбар и навбар
val md_theme_dark_onPrimary = Color(0xFFECE0DF)
...
val md_theme_dark_onSecondary = Color(0xFFC40C13)
